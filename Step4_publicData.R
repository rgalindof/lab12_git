...
#alternatively, you can do the following command, which yields the same result as the past 2 lines of code (extracting expression data expression and transposing) 
# expression <- h5read(archs4.mouse, "data/expression",
...
keepers <- rowSums(archs4.cpm>1)>=2 #this means only keep samples with greater than 1 cpm in greater than or equal to 2 samples/columns
...
#PC2 and PC4 chosen to be graphed based on results of 'PCA small multiples plot'
